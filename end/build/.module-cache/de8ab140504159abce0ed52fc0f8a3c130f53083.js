...
var TodoList = React.createClass({displayName: "TodoList",
    ...
    add: function(e) {
        ...
        if(!newTodo) {
          ...
          arr.push(newTodo);
          this.setState({todos: arr, placeholder:"Add Todo", text: " "});    
        }       
    },
            ...
            React.createElement("div", null, 
                ...
                React.createElement("div", {className: "form-inline"}, 
                    ...
                    React.createElement("div", {className: "form-group"}, 
                        React.createElement("input", {className: this.state.input_style, placeholder: this.state.placeholder, value: this.state.text, ref: "newTodo"}), 
